...
| 잔여 | ⏳ **텍스트 slot overflow는 현재 0**(stale "882"는 폐기). 대사 단어붙음은 Part2 repoint로 214 해소(2026-06-23), 잔여 244건은 Part1·0xB8 분산포인터 영역(테이블 RE 후 확장). · 실기(real GBA) 테스트 · 플레이 중 낱한자 추가 발견분 |
