...
- [x] Part 2 후속 대사/정보 범위의 짧은 일본어 조각 정리.
  - `0xDC0000-0xE18000`에서 `だ！`, `ん？`, `へ？`, `え？`, `ふっ`, `での`, `敵の`, `さあ` 등 짧은 SJIS 조각을 한글 감탄사/조사로 치환.
  - 재스캔 기준 `0xDE0000-0xE18000`의 남은 가나/한자 후보는 이름 입력/문자표 보호 데이터와 예약코드 false positive뿐임을 확인.
